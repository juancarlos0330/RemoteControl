        ...
        <View style={styles.subsection}>
          ...
          >
            <View style={styles.setbtns}>
              <Text style={styles.setbtntxt}>Language settings</Text>
            </View>
          </TouchableOpacity>
          <View style={styles.setpropsbtn}>
            <TouchableOpacity
              style={styles.setpropsbtntouch}
              onPress={() => props.setrouteflagfunc("Settingo")}
            >
              <View style={styles.setpropsleftbtn} />
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.touchview}
              onPress={() => props.setrouteflagfunc("Screensaver")}
            >
              <View style={styles.setbtns}>
                <Text style={styles.setbtntxt}>Screensaver settings</Text>
              </View>
            </TouchableOpacity>
            <TouchableOpacity
          ...
          <TouchableOpacity
            style={styles.touchview}
            onPress={() => props.setrouteflagfunc("Dateset")}
          >
            <View style={styles.setbtns}>
              <Text style={styles.setbtntxt}>Date settings</Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.touchview}
          ...
          >
            <View style={styles.setbtns}>
              <Text style={styles.setbtntxt}>Weekly programmer</Text>
            </View>
          </TouchableOpacity>
          {/* <TouchableOpacity
