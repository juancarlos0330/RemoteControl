      ...
      <View style={styles.section}>
        <View style={styles.subsection}>
          <View style={styles.topletter}>
            ...
            <Text style={styles.toptext}>4/5</Text>
          </View>
          <TouchableOpacity
          ...
          >
            <View style={styles.setbtns}>
              <Text style={styles.setbtntxt}>Report Data (Admin)</Text>
            </View>
          </TouchableOpacity>
          <View style={styles.setpropsbtn}>
            ...
            <TouchableOpacity
              style={styles.touchview}
              onPress={() => props.setrouteflagfunc("Upgrade")}
            >
              <View style={styles.setbtns}>
                <Text style={styles.setbtntxt}>Upgrade</Text>
              </View>
            </TouchableOpacity>
            <TouchableOpacity
          ...
          <TouchableOpacity
            style={styles.touchview}
            onPress={() => props.setrouteflagfunc("Changepassword")}
          >
            <View style={styles.setbtns}>
              <Text style={styles.setbtntxt}>Change password</Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.touchview}
            onPress={() => props.setrouteflagfunc("Probes")}
          >
            <View style={styles.setbtns}>
              <Text style={styles.setbtntxt}>Probes settings</Text>
            </View>
          </TouchableOpacity>
        </View>
      </View>
