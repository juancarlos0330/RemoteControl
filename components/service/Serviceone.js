      ...
      <View style={styles.section}>
        <View style={styles.subsection}>
          <View style={styles.topletter}>
            ...
            <Text style={styles.toptext}>1/5</Text>
          </View>
          <TouchableOpacity
          ...
          >
            <View style={styles.setbtns}>
              <Text style={styles.setbtntxt}>Disconnect Acc.</Text>
            </View>
          </TouchableOpacity>
          <View style={styles.setpropsbtn}>
            ...
            <TouchableOpacity
              style={styles.touchview}
              onPress={() => props.setrouteflagfunc("Ventilation")}
            >
              <View style={styles.setbtns}>
                <Text style={styles.setbtntxt}>Ventilation control</Text>
              </View>
            </TouchableOpacity>
            <TouchableOpacity
          ...
          <TouchableOpacity
            style={styles.touchview}
            onPress={() => props.setrouteflagfunc("Airflow")}
          >
            <View style={styles.setbtns}>
              <Text style={styles.setbtntxt}>Air flow settings</Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.touchview}
          ...
          >
            <View style={styles.setbtns}>
              <Text style={styles.setbtntxt}>Input settings</Text>
            </View>
          </TouchableOpacity>
        </View>
      </View>
