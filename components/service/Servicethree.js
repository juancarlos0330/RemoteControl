      ...
      <View style={styles.section}>
        <View style={styles.subsection}>
          <View style={styles.topletter}>
            ...
            <Text style={styles.toptext}>3/5</Text>
          </View>
          <TouchableOpacity
            style={styles.touchview}
            onPress={() => props.setrouteflagfunc("Rhsetting")}
          >
            <View style={styles.setbtns}>
              <Text style={styles.setbtntxt}>Rh settings</Text>
            </View>
          </TouchableOpacity>
          <View style={styles.setpropsbtn}>
            ...
            <TouchableOpacity
              style={styles.touchview}
              onPress={() => props.setrouteflagfunc("Cosetting")}
            >
              <View style={styles.setbtns}>
                <Text style={styles.setbtntxt}>Co2 settings</Text>
              </View>
            </TouchableOpacity>
            <TouchableOpacity
          ...
          <TouchableOpacity
            style={styles.touchview}
            onPress={() => props.setrouteflagfunc("Vocsetting")}
          >
            <View style={styles.setbtns}>
              <Text style={styles.setbtntxt}>Voc settings</Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.touchview}
            onPress={() => props.setrouteflagfunc("Temper")}
          >
            <View style={styles.setbtns}>
              <Text style={styles.setbtntxt}>Temper. Hysteresis</Text>
            </View>
          </TouchableOpacity>
        </View>
      </View>
