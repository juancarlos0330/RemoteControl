        ...
        <View style={styles.subsection}>
          <View style={styles.main}>
            <View style={styles.topletter}>
              <Text style={styles.toptext}>Thursday</Text>
            </View>
          ...
          <View style={{ width: "100%" }}>
            ...
            <View style={styles.bottomsection}>
              ...
              <TouchableOpacity
                ...
                onPress={() => props.setrouteflagfunc("Wednesdays")}
              >
                <Text style={styles.bottomtext}>{"<<"}</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={styles.bottomviewleft}
                onPress={() => props.setrouteflagfunc("Fridays")}
              >
                <Text style={styles.bottomtext}>{">>"}</Text>
              </TouchableOpacity>
              {/* <TouchableOpacity
